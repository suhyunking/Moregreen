...
노션
https://imminent-wishbone-9d3.notion.site/2-804cd51c5e8e473bbb53fdb5b1e6cb4f
...
펀딩 기능 
이수남(게시판 CRUD 처리, 펀딩 및 관리자 페이징/필터/검색 처리, 스케줄링 처리, 실시간 알림, 다음 주소 API, 카카오페이 API 연동, 클라우드 배포), 김수현(프런트 담당)
